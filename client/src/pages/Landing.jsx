    ...
    <>
      ...
      <div class="containerr">
        ...
        <div className="custom-text">
         ...
         <p className='harnes container'>
          <div className='content-tab'>
          <div>Welcome to Our <span className='space'> Website</span></div>

          </div>

          Explore expert marketing strategies and elevate
           your online presence with captivating blog and 
           high-quality article content on our website. 
          </p>
                 </div>
